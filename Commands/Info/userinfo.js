...
const statuses = {
  online: "<:online:952581376304091226> Online",
  offline: "<:offline:952581356796387328> Offline",
  dnd: "<:donotdisturb:952581406574391296> DND",
  idle: "<:idle:952581435775156324> Idle",
};
    ...
    try {
      const embed = new EmbedBuilder()
        ...
        .addFields([
          ...
          **Avatar:** [Link Here](${member.user.displayAvatarURL({
            dynamic: true,
            size: 1024,
          })})
          **Status:** ${status}
